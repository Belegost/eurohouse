...
document.addEventListener("DOMContentLoaded", function (event) {
  var TagPag = {
    ...
    setData: function setData() {
      ...
      getJSON("https://apiprod.denisglazkov.best/tag/".concat(this.id)).then(function (data) {
        ...
        function getImages() {
          return new Promise(function (resolve, reject) {
            for (var i = 0; i < data.data.relationships.length; i++) {
              getJSON("https://apiprod.denisglazkov.best/image/".concat(data.data.relationships[i].id)).then(function (data) {
