...
document.addEventListener("DOMContentLoaded", function (event) {
  var TagPag = {
    ...
    setData: function setData() {
      ...
      getJSON("https://admin.eurohouse.ca/tag/".concat(this.id)).then(function (data) {
        ...
        function getImages() {
          return new Promise(function (resolve, reject) {
            for (var i = 0; i < data.data.relationships.length; i++) {
              getJSON("https://admin.eurohouse.ca/image/".concat(data.data.relationships[i].id)).then(function (data) {
        ...
        getImages().then(function (tags) {
          ...
          var _loop = function _loop(i) {
            var img = "https://admin.eurohouse.ca/static".concat(tags[i].uri);

            if (tags[i].id != null) {
              getJSON("https://admin.eurohouse.ca/project/".concat(tags[i].id)).then(function (project) {
