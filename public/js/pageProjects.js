...
document.addEventListener("DOMContentLoaded", function (event) {
  var ProjectsPage = {
    setData: function setData() {
      ...
      getJSON('https://admin.eurohouse.ca/tag/list').then(function (data) {
        var tags = {};
      ...
      getJSON('https://admin.eurohouse.ca/project/list').then(function (data) {
        ...
        function getImages() {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var _loop = function _loop(_prop) {
              getJSON("https://admin.eurohouse.ca/image/".concat(data[_prop].imgID)).then(function (img) {
        ...
        getImages().then(function () {
          for (var i = 0; i < sortProjects.length; i++) {
            ...
            var element = "\n                        <div class=\"projects__project\">\n                            <a class=\"projects__img\" href=\"/project/".concat(sortProjects[i][1].id, "\" style=\"background-image: url('https://admin.eurohouse.ca/static").concat(sortProjects[i][1].imgURI, "')\">\n                                <div class=\"projects__info\">\n                                    <div class=\"box\">\n                                        <div class=\"draw\">\n                                            <span class=\"top\"></span>\n                                            <span class=\"right\"></span>\n                                            <span class=\"bottom\"></span>\n                                            <span class=\"left\"></span>\n                                            <h3 class=\"projects__name\">").concat(sortProjects[i][1].title, "</h3>\n                                        </div>\n                                    </div>\n                                </div>\n                                <div class=\"projects__hidenName\">").concat(sortProjects[i][1].title, "</div>\n                            </a>\n                        </div>");
