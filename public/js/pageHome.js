      ...
      getJSON('https://apiprod.denisglazkov.best/project/list').then(function (data) {
        ...
        function getImages() {
          ...
          return new Promise(function (resolve, reject) {
            ...
            var _loop = function _loop(_prop) {
              getJSON("https://apiprod.denisglazkov.best/image/".concat(data.project[_prop].imgID)).then(function (img) {
        ...
        getImages().then(function () {
          for (var i = 0; i < sortProjects.length; i++) {
            ...
            project.style.cssText = "background-image: url(https://apiprod.denisglazkov.best/static".concat(sortProjects[i][1].imgURI, "); transition-delay: ").concat(i * 100 + 300, "ms;");
