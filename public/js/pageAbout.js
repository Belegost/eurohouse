...
/******/ 	deferredModules.push(["./src/js/import/pages/about-us-page.js","vendor"]);
...
/***/ "./src/js/import/pages/about-us-page.js":
/*!**********************************************!*\
  !*** ./src/js/import/pages/about-us-page.js ***!
  \**********************************************/
/*! no exports provided */
...
document.addEventListener("DOMContentLoaded", function (event) {
  var Numbers = {
    numbersSection: document.querySelector('.numbers'),
    windowHeight: document.documentElement.clientHeight,
    animate: true,
    isVisible: function isVisible(elem) {
      var coords = elem.getBoundingClientRect();
      var topVisible = coords.top >= 0 && coords.top < this.windowHeight;
      var bottomVisible = coords.bottom < this.windowHeight && coords.bottom >= 0;
